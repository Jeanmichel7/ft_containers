...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/09/18 21:51:01 by jrasser           #+#    #+#             */
/*   Updated: 2022/09/18 21:58:01 by jrasser          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
public:
    ...
    _Rb_tree &
    operator=(_Rb_tree &&)
        noexcept(_Alloc_traits::_S_nothrow_move() && is_nothrow_move_assignable<_Compare>::value);
...
public:
    ...
    _M_reinsert_node_unique(node_type &&__nh)
    {
        ...
        else
        {
            ...
            if (__res.second)
            {
                __ret.position = _M_insert_node(__res.first, __res.second, __nh._M_ptr);
                __nh._M_ptr = nullptr;
                __ret.inserted = true;
            }
            else
