...
/*   Updated: 2022/09/13 17:22:06 by jrasser          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class map
{
	...
	struct _Rb_tree_key_compare
	{
		...
		_Rb_tree_key_compare(_Rb_tree_key_compare &&__x) noexcept(std::is_nothrow_copy_constructible<_Key_compare>::value)
...
private:
	...
	typedef 	typename allocator_type::template rebind<node<value_type> >::other 		alloc_node_type;
	typedef 	typename allocator_type::template rebind<node<value_type>* >::other 	alloc_node_ptr_type;
	typedef 	typename allocator_type::template rebind<node<value_type>** >::other 	alloc_node_ptr_ptr_type;

	typedef 	node<value_type> 								node_type;
	typedef 	node<value_type>* 								node_ptr_type;
	typedef 	node<value_type>** 								node_ptr_ptr_type;
