...
/*   Updated: 2022/09/16 20:44:37 by jrasser          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
public:
    ...
    pointer operator->() const {
        return std::__addressof(__i_->__get_value());
    };
...
public:
    ...
    map_const_iterator() {}
    // map_const_iterator(const _TreeIterator& __x) : __i_(__x) {}
    ...
    map_const_iterator& operator++() {++__i_; return *this;}
